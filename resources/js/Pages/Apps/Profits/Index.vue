<template>
    <Head>
        <title>Report Profits - Aplikasi Inventory</title>
    </Head>
    <main class="c-main">
                                ...
                                <div v-if="profits">
                                    ...
                                    <div class="export text-end mb-3">
                                        <a
                                            ...
                                            target="_blank"
                                            class="btn btn-info text-white btn-md border-0 shadow me-3"
                                        ...
                                        <a
                                            ...
                                            target="_blank"
                                            class="btn btn-danger text-white btn-md border-0 shadow"
